...
export async function runDonorScan(options: RunDonorScanOptions): Promise<DonorScanResult> {
  ...
  const prioritizedSectionSkinPageLockApprovalBundleProfiles = sectionSkinPageLockApprovalBundleProfiles.sections.filter((section) =>
    section.unresolvedPageLockCount > 0
    || section.approvalReadyPageCount > 0
    || section.exactPageLockCount > 0
  );
  ...
  const prioritizedSectionSkinPageLockApplyBundleProfiles = sectionSkinPageLockApplyBundleProfiles.sections.filter((section) =>
    section.unresolvedPageLockCount > 0
  ...
  const prioritizedSectionSkinTextureLockBundleProfiles = sectionSkinTextureLockBundleProfiles.sections.filter((section) =>
    section.unresolvedPageLockCount > 0
    || section.appliedPageLockCount > 0
    || section.exactPageLockCount > 0
  );
  ...
  const prioritizedSectionSkinTextureAssemblyBundleProfiles = sectionSkinTextureAssemblyBundleProfiles.sections.filter((section) =>
    section.unresolvedPageLockCount > 0
  ...
  const prioritizedSectionSkinTextureCanvasBundleProfiles = sectionSkinTextureCanvasBundleProfiles.sections.filter((section) =>
    section.readyPageCount > 0
    || section.blockedPageCount > 0
    || section.pageSizeCount > 0
    || section.unresolvedPageLockCount > 0
  ...
  const prioritizedSectionSkinTextureSourceFitBundleProfiles = sectionSkinTextureSourceFitBundleProfiles.sections.filter((section) =>
    section.readyPageCount > 0
    || section.blockedPageCount > 0
    || section.missingSourceDimensionCount > 0
    || section.nonUniformScalePageFitCount > 0
    || section.unresolvedPageLockCount > 0
  );
  ...
  const prioritizedSectionSkinTextureFitReviewBundleProfiles = sectionSkinTextureFitReviewBundleProfiles.sections.filter((section) =>
    section.reviewReadyPageCount > 0
    || section.blockedPageCount > 0
    || section.missingSourceDimensionCount > 0
    || section.nonUniformScalePageFitCount > 0
  ...
  const prioritizedSectionSkinTextureFitDecisionBundleProfiles = sectionSkinTextureFitDecisionBundleProfiles.sections.filter((section) =>
    section.reviewReadyPageCount > 0
    || section.blockedPageCount > 0
    || section.missingSourceDimensionCount > 0
    || section.proposedContainDecisionCount > 0
    || section.proposedCoverDecisionCount > 0
  ...
  const prioritizedSectionSkinTextureFitApprovalBundleProfiles = sectionSkinTextureFitApprovalBundleProfiles.sections.filter((section) =>
    section.approvalReadyPageCount > 0
    || section.blockedPageCount > 0
    || section.missingSourceDimensionCount > 0
    || section.proposedContainDecisionCount > 0
  ...
  const scanSummary = {
    ...
    topSectionSkinPageLockReviewBundleKeys: prioritizedSectionSkinPageLockReviewBundleProfiles
      .slice(0, 8)
      .map((section) => section.sectionKey),
    sectionSkinPageLockApprovalBundleCount: sectionSkinPageLockApprovalBundleProfiles.sectionCount,
    topSectionSkinPageLockApprovalBundleKeys: prioritizedSectionSkinPageLockApprovalBundleProfiles
      .slice(0, 8)
      .map((section) => section.sectionKey),
    sectionSkinPageLockApplyBundleCount: sectionSkinPageLockApplyBundleProfiles.sectionCount,
    topSectionSkinPageLockApplyBundleKeys: prioritizedSectionSkinPageLockApplyBundleProfiles
      .slice(0, 8)
      .map((section) => section.sectionKey),
    sectionSkinTextureLockBundleCount: sectionSkinTextureLockBundleProfiles.sectionCount,
    topSectionSkinTextureLockBundleKeys: prioritizedSectionSkinTextureLockBundleProfiles
      .slice(0, 8)
      .map((section) => section.sectionKey),
    ...
    topSectionSkinTextureRenderBundleKeys: prioritizedSectionSkinTextureRenderBundleProfiles
      .slice(0, 8)
      .map((section) => section.sectionKey),
    sectionSkinTextureCanvasBundleCount: sectionSkinTextureCanvasBundleProfiles.sectionCount,
    topSectionSkinTextureCanvasBundleKeys: prioritizedSectionSkinTextureCanvasBundleProfiles
      .slice(0, 8)
      .map((section) => section.sectionKey),
    sectionSkinTextureSourceFitBundleCount: sectionSkinTextureSourceFitBundleProfiles.sectionCount,
    topSectionSkinTextureSourceFitBundleKeys: prioritizedSectionSkinTextureSourceFitBundleProfiles
      .slice(0, 8)
      .map((section) => section.sectionKey),
    sectionSkinTextureFitReviewBundleCount: sectionSkinTextureFitReviewBundleProfiles.sectionCount,
    topSectionSkinTextureFitReviewBundleKeys: prioritizedSectionSkinTextureFitReviewBundleProfiles
      .slice(0, 8)
      .map((section) => section.sectionKey),
    sectionSkinTextureFitDecisionBundleCount: sectionSkinTextureFitDecisionBundleProfiles.sectionCount,
    topSectionSkinTextureFitDecisionBundleKeys: prioritizedSectionSkinTextureFitDecisionBundleProfiles
      .slice(0, 8)
      .map((section) => section.sectionKey),

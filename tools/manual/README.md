...
The current shell edits reconstructed internal scene data under `40_projects/project_001/internal`; donor evidence stays read-only and is not a drag/drop asset browser in this build.

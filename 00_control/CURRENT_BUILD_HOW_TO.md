...
14. If you need grounded runtime proof for that same page cue, use **Open Page Runtime** when a page-linked runtime trace already exists, or **Open Debug Host** when the dedicated Runtime Debug Host is still the strongest truthful path.

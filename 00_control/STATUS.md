...
## Current Phase
- Active scope: PHASE 5R live shell create -> resize -> save -> reload proof on top of the existing slot-first implementation slice.

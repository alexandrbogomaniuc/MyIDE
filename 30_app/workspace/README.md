...
- `syncProject.ts` runs the deterministic editable-scene to replay-project export explicitly when needed.
...
For `project_001`, save also regenerates the replay-facing `40_projects/project_001/project.json` scene from the internal editable scene files, including bounded placeholder width/height changes.

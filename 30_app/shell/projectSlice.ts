...
export interface DonorScanStatus {
  ...
  sectionSkinTextureCanvasBundleProfilesPath: string | null;
  sectionSkinTextureSourceFitBundleProfilesPath: string | null;
  sectionSkinTextureFitReviewBundleProfilesPath: string | null;
  sectionSkinTextureFitDecisionBundleProfilesPath: string | null;
  sectionSkinTextureFitApprovalBundleProfilesPath: string | null;
  sectionSkinTextureFitApplyBundleProfilesPath: string | null;
  ...
  sectionSkinTextureCanvasBundleCount: number;
  ...
  sectionSkinTextureFitDecisionBundleCount: number;
  topSectionSkinTextureFitDecisionBundleKeys: string[];
  sectionSkinTextureFitApprovalBundleCount: number;
  topSectionSkinTextureFitApprovalBundleKeys: string[];
  sectionSkinTextureFitApplyBundleCount: number;
  topSectionSkinTextureFitApplyBundleKeys: string[];
  ...
  sectionActionSkinTextureCanvasBundlePath: string | null;
  sectionActionSkinTextureSourceFitBundlePath: string | null;
  sectionActionSkinTextureFitReviewBundlePath: string | null;
  sectionActionSkinTextureFitDecisionBundlePath: string | null;
  sectionActionSkinTextureFitApprovalBundlePath: string | null;
  sectionActionSkinTextureFitApplyBundlePath: string | null;
  ...
  topSectionSkinTextureCanvasBundleProfiles: Array<{
    familyName: string;
    sectionKey: string;
    skinName: string;
  ...
  topSectionSkinTextureSourceFitBundleProfiles: Array<{
    familyName: string;
    sectionKey: string;
    skinName: string;
  ...
  topSectionSkinTextureFitReviewBundleProfiles: Array<{
    familyName: string;
    sectionKey: string;
    skinName: string;
    textureFitReviewState: string;
    textureSourceFitState: string;
    pageCount: number;
    pageSizeCount: number;
    sourceDimensionCount: number;
  ...
  topSectionSkinTextureFitDecisionBundleProfiles: Array<{
    familyName: string;
    sectionKey: string;
    skinName: string;
    textureFitDecisionState: string;
    textureFitReviewState: string;
    pageCount: number;
    pageSizeCount: number;
    sourceDimensionCount: number;
  ...
  topSectionSkinTextureFitApprovalBundleProfiles: Array<{
    familyName: string;
    sectionKey: string;
    skinName: string;
  ...
  topSectionSkinTextureFitApplyBundleProfiles: Array<{
    familyName: string;
    sectionKey: string;
    skinName: string;
...
export interface InvestigationStatusSummary {
  ...
  scenarioCatalogPath: string | null;
  scenarioCoveragePath: string | null;
  scenarioCaptureLogPath: string | null;
  nextScenarioTargetsPath: string | null;
  scenarioBlockerSummaryPath: string | null;
...
async function loadDonorScanStatus(selectedProject: WorkspaceProjectSummary | null): Promise<DonorScanStatus | null> {
  ...
  const sectionSkinTextureCanvasBundleProfilesPath = `10_donors/${donorId}/evidence/local_only/harvest/section-skin-texture-canvas-bundle-profiles.json`;
  const sectionSkinTextureSourceFitBundleProfilesPath = `10_donors/${donorId}/evidence/local_only/harvest/section-skin-texture-source-fit-bundle-profiles.json`;
  const sectionSkinTextureFitReviewBundleProfilesPath = `10_donors/${donorId}/evidence/local_only/harvest/section-skin-texture-fit-review-bundle-profiles.json`;
  const sectionSkinTextureFitDecisionBundleProfilesPath = `10_donors/${donorId}/evidence/local_only/harvest/section-skin-texture-fit-decision-bundle-profiles.json`;
  const sectionSkinTextureFitApprovalBundleProfilesPath = `10_donors/${donorId}/evidence/local_only/harvest/section-skin-texture-fit-approval-bundle-profiles.json`;
  const sectionSkinTextureFitApplyBundleProfilesPath = `10_donors/${donorId}/evidence/local_only/harvest/section-skin-texture-fit-apply-bundle-profiles.json`;
  ...
  const [scanSummary, blockerSummaryMarkdown, nextCaptureTargetsFile, captureRunSummary, captureTargetFamiliesFile, captureFamilySourceProfilesFile, captureFamilyActionsFile, familyReconstructionProfilesFile, familyReconstructionMapsFile, familyReconstructionSectionsFile, familyReconstructionSectionBundlesFile, sectionReconstructionProfilesFile, sectionSkinBlueprintProfilesFile, sectionSkinRenderPlanProfilesFile, sectionSkinMaterialPlanProfilesFile, sectionSkinMaterialReviewBundleProfilesFile, sectionSkinPageMatchBundleProfilesFile, sectionSkinPageLockBundleProfilesFile, sectionSkinPageLockAuditBundleProfilesFile, sectionSkinPageLockResolutionBundleProfilesFile, sectionSkinPageLockDecisionBundleProfilesFile, sectionSkinPageLockReviewBundleProfilesFile, sectionSkinPageLockApprovalBundleProfilesFile, sectionSkinPageLockApplyBundleProfilesFile, sectionSkinTextureInputBundleProfilesFile, sectionSkinTextureSourcePlanProfilesFile, sectionSkinTextureReconstructionBundleProfilesFile, sectionSkinTextureLockBundleProfilesFile, sectionSkinTextureAssemblyBundleProfilesFile, sectionSkinTextureRenderBundleProfilesFile, sectionSkinTextureCanvasBundleProfilesFile, sectionSkinTextureSourceFitBundleProfilesFile, sectionSkinTextureFitReviewBundleProfilesFile, sectionSkinTextureFitDecisionBundleProfilesFile, sectionSkinTextureFitApprovalBundleProfilesFile, sectionSkinTextureFitApplyBundleProfilesFile, familyActionRunSummary, sectionActionRunSummary] = await Promise.all([
    ...
    readOptionalJsonFile(path.join(workspaceRoot, sectionSkinTextureCanvasBundleProfilesPath)) as Promise<JsonObject | null>,
    readOptionalJsonFile(path.join(workspaceRoot, sectionSkinTextureSourceFitBundleProfilesPath)) as Promise<JsonObject | null>,
    readOptionalJsonFile(path.join(workspaceRoot, sectionSkinTextureFitReviewBundleProfilesPath)) as Promise<JsonObject | null>,
    readOptionalJsonFile(path.join(workspaceRoot, sectionSkinTextureFitDecisionBundleProfilesPath)) as Promise<JsonObject | null>,
    readOptionalJsonFile(path.join(workspaceRoot, sectionSkinTextureFitApprovalBundleProfilesPath)) as Promise<JsonObject | null>,
    readOptionalJsonFile(path.join(workspaceRoot, sectionSkinTextureFitApplyBundleProfilesPath)) as Promise<JsonObject | null>,
  ...
  const topSectionSkinTextureRenderBundleProfiles = Array.isArray(sectionSkinTextureRenderBundleProfilesFile?.sections)
    ? sectionSkinTextureRenderBundleProfilesFile.sections
        ...
        .slice(0, 6)
    : [];
  const topSectionSkinTextureCanvasBundleProfiles = Array.isArray(sectionSkinTextureCanvasBundleProfilesFile?.sections)
    ? sectionSkinTextureCanvasBundleProfilesFile.sections
        .filter((value): value is JsonObject => Boolean(value) && typeof value === "object" && !Array.isArray(value))
        .map((section) => ({
          familyName: typeof section.familyName === "string" ? section.familyName : "",
          sectionKey: typeof section.sectionKey === "string" ? section.sectionKey : "",
          skinName: typeof section.skinName === "string" ? section.skinName : "",
          textureCanvasState: typeof section.textureCanvasState === "string" ? section.textureCanvasState : "unknown",
          pageCount: typeof section.pageCount === "number" ? section.pageCount : 0,
          pageSizeCount: typeof section.pageSizeCount === "number" ? section.pageSizeCount : 0,
          missingPageSizeCount: typeof section.missingPageSizeCount === "number" ? section.missingPageSizeCount : 0,
          exactPageLockCount: typeof section.exactPageLockCount === "number" ? section.exactPageLockCount : 0,
          ...
          blockedPageCount: typeof section.blockedPageCount === "number" ? section.blockedPageCount : 0,
          uniqueSelectedLocalPathCount: typeof section.uniqueSelectedLocalPathCount === "number" ? section.uniqueSelectedLocalPathCount : 0,
          drawOperationCount: typeof section.drawOperationCount === "number" ? section.drawOperationCount : 0,
          readyDrawOperationCount: typeof section.readyDrawOperationCount === "number" ? section.readyDrawOperationCount : 0,
          blockedDrawOperationCount: typeof section.blockedDrawOperationCount === "number" ? section.blockedDrawOperationCount : 0,
          topCanvasLocalPath: typeof section.topCanvasLocalPath === "string" ? section.topCanvasLocalPath : null,
          sampleLocalSourcePath: typeof section.sampleLocalSourcePath === "string" ? section.sampleLocalSourcePath : null,
          atlasSourcePath: typeof section.atlasSourcePath === "string" ? section.atlasSourcePath : null,
          textureCanvasBundlePath: typeof section.textureCanvasBundlePath === "string" ? section.textureCanvasBundlePath : "",
          nextTextureCanvasStep: typeof section.nextTextureCanvasStep === "string" ? section.nextTextureCanvasStep : "Review the section skin texture canvas bundle."
        }))
        .filter((section) => section.sectionKey.length > 0 && section.textureCanvasBundlePath.length > 0)
        .slice(0, 6)
    : [];
  const topSectionSkinTextureSourceFitBundleProfiles = Array.isArray(sectionSkinTextureSourceFitBundleProfilesFile?.sections)
    ? sectionSkinTextureSourceFitBundleProfilesFile.sections
        .filter((value): value is JsonObject => Boolean(value) && typeof value === "object" && !Array.isArray(value))
        .map((section) => ({
          familyName: typeof section.familyName === "string" ? section.familyName : "",
          sectionKey: typeof section.sectionKey === "string" ? section.sectionKey : "",
          skinName: typeof section.skinName === "string" ? section.skinName : "",
          textureSourceFitState: typeof section.textureSourceFitState === "string" ? section.textureSourceFitState : "unknown",
          pageCount: typeof section.pageCount === "number" ? section.pageCount : 0,
          pageSizeCount: typeof section.pageSizeCount === "number" ? section.pageSizeCount : 0,
          sourceDimensionCount: typeof section.sourceDimensionCount === "number" ? section.sourceDimensionCount : 0,
          missingPageSizeCount: typeof section.missingPageSizeCount === "number" ? section.missingPageSizeCount : 0,
          missingSourceDimensionCount: typeof section.missingSourceDimensionCount === "number" ? section.missingSourceDimensionCount : 0,
          exactPageLockCount: typeof section.exactPageLockCount === "number" ? section.exactPageLockCount : 0,
          appliedPageLockCount: typeof section.appliedPageLockCount === "number" ? section.appliedPageLockCount : 0,
          unresolvedPageLockCount: typeof section.unresolvedPageLockCount === "number" ? section.unresolvedPageLockCount : 0,
          exactPageFitCount: typeof section.exactPageFitCount === "number" ? section.exactPageFitCount : 0,
          uniformScalePageFitCount: typeof section.uniformScalePageFitCount === "number" ? section.uniformScalePageFitCount : 0,
          nonUniformScalePageFitCount: typeof section.nonUniformScalePageFitCount === "number" ? section.nonUniformScalePageFitCount : 0,
          readyPageCount: typeof section.readyPageCount === "number" ? section.readyPageCount : 0,
          blockedPageCount: typeof section.blockedPageCount === "number" ? section.blockedPageCount : 0,
          uniqueSelectedLocalPathCount: typeof section.uniqueSelectedLocalPathCount === "number" ? section.uniqueSelectedLocalPathCount : 0,
          drawOperationCount: typeof section.drawOperationCount === "number" ? section.drawOperationCount : 0,
          readyDrawOperationCount: typeof section.readyDrawOperationCount === "number" ? section.readyDrawOperationCount : 0,
          blockedDrawOperationCount: typeof section.blockedDrawOperationCount === "number" ? section.blockedDrawOperationCount : 0,
          topFittedLocalPath: typeof section.topFittedLocalPath === "string" ? section.topFittedLocalPath : null,
          sampleLocalSourcePath: typeof section.sampleLocalSourcePath === "string" ? section.sampleLocalSourcePath : null,
          atlasSourcePath: typeof section.atlasSourcePath === "string" ? section.atlasSourcePath : null,
          textureSourceFitBundlePath: typeof section.textureSourceFitBundlePath === "string" ? section.textureSourceFitBundlePath : "",
          nextTextureSourceFitStep: typeof section.nextTextureSourceFitStep === "string" ? section.nextTextureSourceFitStep : "Review the section skin texture source-fit bundle."
        }))
        .filter((section) => section.sectionKey.length > 0 && section.textureSourceFitBundlePath.length > 0)
        .slice(0, 6)
    : [];
  const topSectionSkinTextureFitReviewBundleProfiles = Array.isArray(sectionSkinTextureFitReviewBundleProfilesFile?.sections)
    ? sectionSkinTextureFitReviewBundleProfilesFile.sections
        .filter((value): value is JsonObject => Boolean(value) && typeof value === "object" && !Array.isArray(value))
        .map((section) => ({
          familyName: typeof section.familyName === "string" ? section.familyName : "",
          sectionKey: typeof section.sectionKey === "string" ? section.sectionKey : "",
          skinName: typeof section.skinName === "string" ? section.skinName : "",
          textureFitReviewState: typeof section.textureFitReviewState === "string" ? section.textureFitReviewState : "unknown",
          textureSourceFitState: typeof section.textureSourceFitState === "string" ? section.textureSourceFitState : "unknown",
          pageCount: typeof section.pageCount === "number" ? section.pageCount : 0,
          pageSizeCount: typeof section.pageSizeCount === "number" ? section.pageSizeCount : 0,
          sourceDimensionCount: typeof section.sourceDimensionCount === "number" ? section.sourceDimensionCount : 0,
          ...
          readyDrawOperationCount: typeof section.readyDrawOperationCount === "number" ? section.readyDrawOperationCount : 0,
          blockedDrawOperationCount: typeof section.blockedDrawOperationCount === "number" ? section.blockedDrawOperationCount : 0,
          largestScaleDelta: typeof section.largestScaleDelta === "number" ? section.largestScaleDelta : null,
          topFitReviewLocalPath: typeof section.topFitReviewLocalPath === "string" ? section.topFitReviewLocalPath : null,
          sampleLocalSourcePath: typeof section.sampleLocalSourcePath === "string" ? section.sampleLocalSourcePath : null,
          atlasSourcePath: typeof section.atlasSourcePath === "string" ? section.atlasSourcePath : null,
          textureFitReviewBundlePath: typeof section.textureFitReviewBundlePath === "string" ? section.textureFitReviewBundlePath : "",
          nextTextureFitReviewStep: typeof section.nextTextureFitReviewStep === "string" ? section.nextTextureFitReviewStep : "Review the section skin texture fit-review bundle."
        }))
        .filter((section) => section.sectionKey.length > 0 && section.textureFitReviewBundlePath.length > 0)
        .slice(0, 6)
    : [];
  const topSectionSkinTextureFitDecisionBundleProfiles = Array.isArray(sectionSkinTextureFitDecisionBundleProfilesFile?.sections)
    ? sectionSkinTextureFitDecisionBundleProfilesFile.sections
        .filter((value): value is JsonObject => Boolean(value) && typeof value === "object" && !Array.isArray(value))
        .map((section) => ({
          familyName: typeof section.familyName === "string" ? section.familyName : "",
          sectionKey: typeof section.sectionKey === "string" ? section.sectionKey : "",
          skinName: typeof section.skinName === "string" ? section.skinName : "",
          textureFitDecisionState: typeof section.textureFitDecisionState === "string" ? section.textureFitDecisionState : "unknown",
          textureFitReviewState: typeof section.textureFitReviewState === "string" ? section.textureFitReviewState : "unknown",
          pageCount: typeof section.pageCount === "number" ? section.pageCount : 0,
          pageSizeCount: typeof section.pageSizeCount === "number" ? section.pageSizeCount : 0,
          sourceDimensionCount: typeof section.sourceDimensionCount === "number" ? section.sourceDimensionCount : 0,
          ...
          appliedPageLockCount: typeof section.appliedPageLockCount === "number" ? section.appliedPageLockCount : 0,
          unresolvedPageLockCount: typeof section.unresolvedPageLockCount === "number" ? section.unresolvedPageLockCount : 0,
          exactFitDecisionCount: typeof section.exactFitDecisionCount === "number" ? section.exactFitDecisionCount : 0,
          uniformFitDecisionCount: typeof section.uniformFitDecisionCount === "number" ? section.uniformFitDecisionCount : 0,
          proposedContainDecisionCount: typeof section.proposedContainDecisionCount === "number" ? section.proposedContainDecisionCount : 0,
          proposedCoverDecisionCount: typeof section.proposedCoverDecisionCount === "number" ? section.proposedCoverDecisionCount : 0,
          proposedStretchDecisionCount: typeof section.proposedStretchDecisionCount === "number" ? section.proposedStretchDecisionCount : 0,
          reviewReadyPageCount: typeof section.reviewReadyPageCount === "number" ? section.reviewReadyPageCount : 0,
          blockedPageCount: typeof section.blockedPageCount === "number" ? section.blockedPageCount : 0,
          uniqueSelectedLocalPathCount: typeof section.uniqueSelectedLocalPathCount === "number" ? section.uniqueSelectedLocalPathCount : 0,
          drawOperationCount: typeof section.drawOperationCount === "number" ? section.drawOperationCount : 0,
          readyDrawOperationCount: typeof section.readyDrawOperationCount === "number" ? section.readyDrawOperationCount : 0,
          blockedDrawOperationCount: typeof section.blockedDrawOperationCount === "number" ? section.blockedDrawOperationCount : 0,
          largestOccupancyCoverageRatio: typeof section.largestOccupancyCoverageRatio === "number" ? section.largestOccupancyCoverageRatio : null,
          largestScaleDelta: typeof section.largestScaleDelta === "number" ? section.largestScaleDelta : null,
          topDecisionLocalPath: typeof section.topDecisionLocalPath === "string" ? section.topDecisionLocalPath : null,
          sampleLocalSourcePath: typeof section.sampleLocalSourcePath === "string" ? section.sampleLocalSourcePath : null,
          atlasSourcePath: typeof section.atlasSourcePath === "string" ? section.atlasSourcePath : null,
          textureFitDecisionBundlePath: typeof section.textureFitDecisionBundlePath === "string" ? section.textureFitDecisionBundlePath : "",
          nextTextureFitDecisionStep: typeof section.nextTextureFitDecisionStep === "string" ? section.nextTextureFitDecisionStep : "Review the section skin texture fit-decision bundle."
        }))
        .filter((section) => section.sectionKey.length > 0 && section.textureFitDecisionBundlePath.length > 0)
        .slice(0, 6)
    : [];
  const topSectionSkinTextureFitApprovalBundleProfiles = Array.isArray(sectionSkinTextureFitApprovalBundleProfilesFile?.sections)
    ? sectionSkinTextureFitApprovalBundleProfilesFile.sections
        .filter((value): value is JsonObject => Boolean(value) && typeof value === "object" && !Array.isArray(value))
        .map((section) => ({
          familyName: typeof section.familyName === "string" ? section.familyName : "",
          sectionKey: typeof section.sectionKey === "string" ? section.sectionKey : "",
          skinName: typeof section.skinName === "string" ? section.skinName : "",
          textureFitApprovalState: typeof section.textureFitApprovalState === "string" ? section.textureFitApprovalState : "unknown",
          textureFitDecisionState: typeof section.textureFitDecisionState === "string" ? section.textureFitDecisionState : "unknown",
          pageCount: typeof section.pageCount === "number" ? section.pageCount : 0,
          pageSizeCount: typeof section.pageSizeCount === "number" ? section.pageSizeCount : 0,
          sourceDimensionCount: typeof section.sourceDimensionCount === "number" ? section.sourceDimensionCount : 0,
          ...
          largestOccupancyCoverageRatio: typeof section.largestOccupancyCoverageRatio === "number" ? section.largestOccupancyCoverageRatio : null,
          largestScaleDelta: typeof section.largestScaleDelta === "number" ? section.largestScaleDelta : null,
          topApprovedLocalPath: typeof section.topApprovedLocalPath === "string" ? section.topApprovedLocalPath : null,
          sampleLocalSourcePath: typeof section.sampleLocalSourcePath === "string" ? section.sampleLocalSourcePath : null,
          atlasSourcePath: typeof section.atlasSourcePath === "string" ? section.atlasSourcePath : null,
          textureFitDecisionBundlePath: typeof section.textureFitDecisionBundlePath === "string" ? section.textureFitDecisionBundlePath : "",
          textureFitApprovalBundlePath: typeof section.textureFitApprovalBundlePath === "string" ? section.textureFitApprovalBundlePath : "",
          nextTextureFitApprovalStep: typeof section.nextTextureFitApprovalStep === "string" ? section.nextTextureFitApprovalStep : "Review the section skin texture fit-approval bundle."
        }))
        .filter((section) => section.sectionKey.length > 0 && section.textureFitApprovalBundlePath.length > 0)
        .slice(0, 6)
    : [];
  const topSectionSkinTextureFitApplyBundleProfiles = Array.isArray(sectionSkinTextureFitApplyBundleProfilesFile?.sections)
    ? sectionSkinTextureFitApplyBundleProfilesFile.sections
        .filter((value): value is JsonObject => Boolean(value) && typeof value === "object" && !Array.isArray(value))
        .map((section) => ({
          familyName: typeof section.familyName === "string" ? section.familyName : "",
          sectionKey: typeof section.sectionKey === "string" ? section.sectionKey : "",
          skinName: typeof section.skinName === "string" ? section.skinName : "",
          textureFitApplyState: typeof section.textureFitApplyState === "string" ? section.textureFitApplyState : "unknown",
          textureFitApprovalState: typeof section.textureFitApprovalState === "string" ? section.textureFitApprovalState : "unknown",
          pageCount: typeof section.pageCount === "number" ? section.pageCount : 0,
          pageSizeCount: typeof section.pageSizeCount === "number" ? section.pageSizeCount : 0,
          sourceDimensionCount: typeof section.sourceDimensionCount === "number" ? section.sourceDimensionCount : 0,
          ...
          exactFitDecisionCount: typeof section.exactFitDecisionCount === "number" ? section.exactFitDecisionCount : 0,
          uniformFitDecisionCount: typeof section.uniformFitDecisionCount === "number" ? section.uniformFitDecisionCount : 0,
          appliedContainFitCount: typeof section.appliedContainFitCount === "number" ? section.appliedContainFitCount : 0,
          appliedCoverFitCount: typeof section.appliedCoverFitCount === "number" ? section.appliedCoverFitCount : 0,
          appliedStretchFitCount: typeof section.appliedStretchFitCount === "number" ? section.appliedStretchFitCount : 0,
          readyPageCount: typeof section.readyPageCount === "number" ? section.readyPageCount : 0,
          blockedPageCount: typeof section.blockedPageCount === "number" ? section.blockedPageCount : 0,
          uniqueSelectedLocalPathCount: typeof section.uniqueSelectedLocalPathCount === "number" ? section.uniqueSelectedLocalPathCount : 0,
          drawOperationCount: typeof section.drawOperationCount === "number" ? section.drawOperationCount : 0,
          ...
          atlasSourcePath: typeof section.atlasSourcePath === "string" ? section.atlasSourcePath : null,
          textureFitApprovalBundlePath: typeof section.textureFitApprovalBundlePath === "string" ? section.textureFitApprovalBundlePath : "",
          textureFitApplyBundlePath: typeof section.textureFitApplyBundlePath === "string" ? section.textureFitApplyBundlePath : "",
          nextTextureFitApplyStep: typeof section.nextTextureFitApplyStep === "string" ? section.nextTextureFitApplyStep : "Use the section skin texture fit-apply bundle as the downstream fit surface."
        }))
        .filter((section) => section.sectionKey.length > 0 && section.textureFitApplyBundlePath.length > 0)
        .slice(0, 6)
    : [];
  ...
  return {
    ...
    sectionSkinTextureCanvasBundleProfilesPath: sectionSkinTextureCanvasBundleProfilesFile ? sectionSkinTextureCanvasBundleProfilesPath : null,
    sectionSkinTextureSourceFitBundleProfilesPath: sectionSkinTextureSourceFitBundleProfilesFile ? sectionSkinTextureSourceFitBundleProfilesPath : null,
    sectionSkinTextureFitReviewBundleProfilesPath: sectionSkinTextureFitReviewBundleProfilesFile ? sectionSkinTextureFitReviewBundleProfilesPath : null,
    sectionSkinTextureFitDecisionBundleProfilesPath: sectionSkinTextureFitDecisionBundleProfilesFile ? sectionSkinTextureFitDecisionBundleProfilesPath : null,
    sectionSkinTextureFitApprovalBundleProfilesPath: sectionSkinTextureFitApprovalBundleProfilesFile ? sectionSkinTextureFitApprovalBundleProfilesPath : null,
    sectionSkinTextureFitApplyBundleProfilesPath: sectionSkinTextureFitApplyBundleProfilesFile ? sectionSkinTextureFitApplyBundleProfilesPath : null,
    ...
    sectionSkinTextureCanvasBundleCount: typeof scanSummary.sectionSkinTextureCanvasBundleCount === "number" ? scanSummary.sectionSkinTextureCanvasBundleCount : topSectionSkinTextureCanvasBundleProfiles.length,
    topSectionSkinTextureCanvasBundleKeys: Array.isArray(scanSummary.topSectionSkinTextureCanvasBundleKeys)
      ? scanSummary.topSectionSkinTextureCanvasBundleKeys.filter((value): value is string => typeof value === "string")
      : topSectionSkinTextureCanvasBundleProfiles.map((section) => section.sectionKey),
    sectionSkinTextureSourceFitBundleCount: typeof scanSummary.sectionSkinTextureSourceFitBundleCount === "number" ? scanSummary.sectionSkinTextureSourceFitBundleCount : topSectionSkinTextureSourceFitBundleProfiles.length,
    topSectionSkinTextureSourceFitBundleKeys: Array.isArray(scanSummary.topSectionSkinTextureSourceFitBundleKeys)
      ? scanSummary.topSectionSkinTextureSourceFitBundleKeys.filter((value): value is string => typeof value === "string")
      : topSectionSkinTextureSourceFitBundleProfiles.map((section) => section.sectionKey),
    sectionSkinTextureFitReviewBundleCount: typeof scanSummary.sectionSkinTextureFitReviewBundleCount === "number" ? scanSummary.sectionSkinTextureFitReviewBundleCount : topSectionSkinTextureFitReviewBundleProfiles.length,
    topSectionSkinTextureFitReviewBundleKeys: Array.isArray(scanSummary.topSectionSkinTextureFitReviewBundleKeys)
      ? scanSummary.topSectionSkinTextureFitReviewBundleKeys.filter((value): value is string => typeof value === "string")
      : topSectionSkinTextureFitReviewBundleProfiles.map((section) => section.sectionKey),
    sectionSkinTextureFitDecisionBundleCount: typeof scanSummary.sectionSkinTextureFitDecisionBundleCount === "number" ? scanSummary.sectionSkinTextureFitDecisionBundleCount : topSectionSkinTextureFitDecisionBundleProfiles.length,
    topSectionSkinTextureFitDecisionBundleKeys: Array.isArray(scanSummary.topSectionSkinTextureFitDecisionBundleKeys)
      ? scanSummary.topSectionSkinTextureFitDecisionBundleKeys.filter((value): value is string => typeof value === "string")
      : topSectionSkinTextureFitDecisionBundleProfiles.map((section) => section.sectionKey),
    sectionSkinTextureFitApprovalBundleCount: typeof scanSummary.sectionSkinTextureFitApprovalBundleCount === "number" ? scanSummary.sectionSkinTextureFitApprovalBundleCount : topSectionSkinTextureFitApprovalBundleProfiles.length,
    topSectionSkinTextureFitApprovalBundleKeys: Array.isArray(scanSummary.topSectionSkinTextureFitApprovalBundleKeys)
      ? scanSummary.topSectionSkinTextureFitApprovalBundleKeys.filter((value): value is string => typeof value === "string")
      : topSectionSkinTextureFitApprovalBundleProfiles.map((section) => section.sectionKey),
    sectionSkinTextureFitApplyBundleCount: typeof scanSummary.sectionSkinTextureFitApplyBundleCount === "number" ? scanSummary.sectionSkinTextureFitApplyBundleCount : topSectionSkinTextureFitApplyBundleProfiles.length,
    topSectionSkinTextureFitApplyBundleKeys: Array.isArray(scanSummary.topSectionSkinTextureFitApplyBundleKeys)
      ? scanSummary.topSectionSkinTextureFitApplyBundleKeys.filter((value): value is string => typeof value === "string")
      : topSectionSkinTextureFitApplyBundleProfiles.map((section) => section.sectionKey),
    ...
    sectionActionSkinTextureCanvasBundlePath: typeof sectionActionRunSummary?.skinTextureCanvasBundlePath === "string" ? sectionActionRunSummary.skinTextureCanvasBundlePath : null,
    sectionActionSkinTextureSourceFitBundlePath: typeof sectionActionRunSummary?.skinTextureSourceFitBundlePath === "string" ? sectionActionRunSummary.skinTextureSourceFitBundlePath : null,
    sectionActionSkinTextureFitReviewBundlePath: typeof sectionActionRunSummary?.skinTextureFitReviewBundlePath === "string" ? sectionActionRunSummary.skinTextureFitReviewBundlePath : null,
    sectionActionSkinTextureFitDecisionBundlePath: typeof sectionActionRunSummary?.skinTextureFitDecisionBundlePath === "string" ? sectionActionRunSummary.skinTextureFitDecisionBundlePath : null,
    sectionActionSkinTextureFitApprovalBundlePath: typeof sectionActionRunSummary?.skinTextureFitApprovalBundlePath === "string" ? sectionActionRunSummary.skinTextureFitApprovalBundlePath : null,
    sectionActionSkinTextureFitApplyBundlePath: typeof sectionActionRunSummary?.skinTextureFitApplyBundlePath === "string" ? sectionActionRunSummary.skinTextureFitApplyBundlePath : null,
    ...
    topSectionSkinTextureCanvasBundleProfiles,
    topSectionSkinTextureSourceFitBundleProfiles,
    topSectionSkinTextureFitReviewBundleProfiles,
    topSectionSkinTextureFitDecisionBundleProfiles,
    topSectionSkinTextureFitApprovalBundleProfiles,
    topSectionSkinTextureFitApplyBundleProfiles,
    nextCaptureTargets
  };
}
...
async function loadInvestigationStatus(selectedProject: WorkspaceProjectSummary | null): Promise<InvestigationStatusSummary | null> {
  ...
  const topScenarioCoverage = getObjectArray(scenarioCoverageFile?.scenarios)
    .map((scenario) => ({
      scenarioId: typeof scenario.scenarioId === "string" ? scenario.scenarioId : "",
      displayName: typeof scenario.displayName === "string" ? scenario.displayName : "",
      state: typeof scenario.state === "string" ? scenario.state : "unknown",
      lane: typeof scenario.lane === "string" ? scenario.lane : "unknown",
      nextProfile: typeof scenario.nextProfile === "string" ? scenario.nextProfile : null,
      nextOperatorAction: typeof scenario.nextOperatorAction === "string" ? scenario.nextOperatorAction : "Review the investigation status.",
      blockerClasses: Array.isArray(scenario.blockerClasses)
        ? scenario.blockerClasses.filter((entry): entry is string => typeof entry === "string" && entry.length > 0)
        : [],
      matchedFamilyNames: Array.isArray(scenario.matchedFamilyNames)
        ? scenario.matchedFamilyNames.filter((entry): entry is string => typeof entry === "string" && entry.length > 0)
        : []
    }))
    .filter((scenario) => scenario.scenarioId.length > 0)
    .slice(0, 8);

  const topScenarioTargets = getObjectArray(nextScenarioTargetsFile?.targets)
    .map((target) => ({
      scenarioId: typeof target.scenarioId === "string" ? target.scenarioId : "",
      displayName: typeof target.displayName === "string" ? target.displayName : "",
      state: typeof target.state === "string" ? target.state : "unknown",
      lane: typeof target.lane === "string" ? target.lane : "unknown",
      nextProfile: typeof target.nextProfile === "string" ? target.nextProfile : null,
      nextOperatorAction: typeof target.nextOperatorAction === "string" ? target.nextOperatorAction : "Review the investigation targets."
    }))
    .filter((target) => target.scenarioId.length > 0)
    .slice(0, 6);
  ...
  return {
    ...
    runtimeScanState: typeof investigationStatusFile.runtimeScanState === "string" ? investigationStatusFile.runtimeScanState : "unknown",
    scenarioCatalogPath: typeof investigationStatusFile.scenarioCatalogPath === "string" ? investigationStatusFile.scenarioCatalogPath : null,
    scenarioCoveragePath: typeof investigationStatusFile.scenarioCoveragePath === "string" ? investigationStatusFile.scenarioCoveragePath : null,
    scenarioCaptureLogPath: typeof investigationStatusFile.scenarioCaptureLogPath === "string" ? investigationStatusFile.scenarioCaptureLogPath : null,
    nextScenarioTargetsPath: typeof investigationStatusFile.nextScenarioTargetsPath === "string" ? investigationStatusFile.nextScenarioTargetsPath : null,
    scenarioBlockerSummaryPath: typeof investigationStatusFile.scenarioBlockerSummaryPath === "string" ? investigationStatusFile.scenarioBlockerSummaryPath : null,
    eventStreamPath: typeof investigationStatusFile.eventStreamPath === "string" ? investigationStatusFile.eventStreamPath : null,
    investigationStatusPath,
    scenarioCount: typeof investigationStatusFile.scenarioCount === "number" ? investigationStatusFile.scenarioCount : 0,
    readyForReconstructionCount: typeof investigationStatusFile.readyForReconstructionCount === "number" ? investigationStatusFile.readyForReconstructionCount : 0,
    blockedScenarioCount: typeof investigationStatusFile.blockedScenarioCount === "number" ? investigationStatusFile.blockedScenarioCount : 0,
    countsByState: investigationStatusFile.countsByState && typeof investigationStatusFile.countsByState === "object" && !Array.isArray(investigationStatusFile.countsByState)
      ? Object.fromEntries(
          Object.entries(investigationStatusFile.countsByState).filter(([, value]) => typeof value === "number")
    ...
    readyScenarioNames: Array.isArray(investigationStatusFile.readyScenarioIds)
      ? investigationStatusFile.readyScenarioIds.filter((entry): entry is string => typeof entry === "string" && entry.length > 0)
      : [],
    blockedScenarioNames: Array.isArray(investigationStatusFile.blockedScenarioNames)
      ? investigationStatusFile.blockedScenarioNames.filter((entry): entry is string => typeof entry === "string" && entry.length > 0)
      : [],
    topScenarioCoverage,
    topScenarioTargets
    ,

...
- Support a stronger runtime pick/inspect flow that can click the live runtime surface, surface the strongest grounded runtime trace we can prove, and jump into the best grounded donor asset, donor evidence, or related compose object context when available.

...
- The shell donor scan summary now also surfaces the top ranked next capture targets, so operators can copy the current missing runtime target set directly from the app instead of opening harvest files by hand.

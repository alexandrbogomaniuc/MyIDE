...
- The shell new-project flow can now take an optional donor launch URL, scaffold a shared donor pack under `10_donors/<donorId>/`, capture the donor launch HTML in sanitized form, write a first-pass discovered URL inventory, and harvest directly discovered static assets into the local-only donor pack before any replay/import claims are made.

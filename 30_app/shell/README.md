...
- The shell donor scan summary now also exposes one **Run Guided Capture** action plus the last guided capture result, so operators can attempt the top ranked missing donor/runtime files and immediately see whether the blocker queue shrank.

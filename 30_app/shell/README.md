...
- Support object selection from the list and canvas, direct canvas move, snap-assisted drag and nudge, selected-object layer reassignment, new placeholder object creation, duplicate/delete for editable objects, bounded property editing, bounded undo/redo, layer visible/locked toggles, save, and reload for the validated `project_001` editor slice.

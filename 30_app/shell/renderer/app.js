    ...
    <div class="detail-grid">
      ...
      <div class="detail-card">
        ...
        ${donorScan?.sectionActionRunStatus ? `
          <div class="detail-list">
            <small><strong>Latest section action</strong> · ${escapeHtml(donorScan.sectionActionRunStatus)} · ${escapeHtml(donorScan.sectionActionRunMode || "unknown")}${donorScan.sectionActionRunSectionKey ? ` · ${escapeHtml(donorScan.sectionActionRunSectionKey)}` : ""}${donorScan.sectionActionWorksetPath ? ` · workset <code>${escapeHtml(donorScan.sectionActionWorksetPath)}</code>` : ""}${donorScan.sectionActionReconstructionBundlePath ? ` · bundle <code>${escapeHtml(donorScan.sectionActionReconstructionBundlePath)}</code>` : ""}${donorScan.sectionActionSkinBlueprintPath ? ` · blueprint <code>${escapeHtml(donorScan.sectionActionSkinBlueprintPath)}</code>` : ""}${donorScan.sectionActionSkinRenderPlanPath ? ` · render plan <code>${escapeHtml(donorScan.sectionActionSkinRenderPlanPath)}</code>` : ""}${donorScan.sectionActionSkinMaterialPlanPath ? ` · material plan <code>${escapeHtml(donorScan.sectionActionSkinMaterialPlanPath)}</code>` : ""}${donorScan.sectionActionSkinMaterialReviewBundlePath ? ` · material review <code>${escapeHtml(donorScan.sectionActionSkinMaterialReviewBundlePath)}</code>` : ""}${donorScan.sectionActionSkinPageMatchBundlePath ? ` · page match <code>${escapeHtml(donorScan.sectionActionSkinPageMatchBundlePath)}</code>` : ""}${donorScan.sectionActionMappedAttachmentCount > 0 ? ` · ${escapeHtml(String(donorScan.sectionActionMappedAttachmentCount))} mapped attachment${donorScan.sectionActionMappedAttachmentCount === 1 ? "" : "s"}` : ""}${donorScan.sectionActionExactLocalSourceCount > 0 ? ` · ${escapeHtml(String(donorScan.sectionActionExactLocalSourceCount))} grounded local source${donorScan.sectionActionExactLocalSourceCount === 1 ? "" : "s"}` : ""}</small>
          </div>
        ` : ""}

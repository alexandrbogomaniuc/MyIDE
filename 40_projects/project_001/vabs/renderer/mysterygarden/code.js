...
(function (root, factory) {
    ...
    function renderSummaryHtml(summary) {
        ...
        return [
            ...
            "  <article class=\"mg-vabs-stub-card\">",
            "    <h2>Comparison</h2>",
            "    <p><span class=\"mg-vabs-stub-label\">Mode</span>" + escapeHtml(summary.comparisonMode || "-") + "</p>",
            ...
            "    <p><span class=\"mg-vabs-stub-label\">Compare Doc</span>" + escapeHtml(summary.comparisonPath || "-") + "</p>",
            "  </article>",

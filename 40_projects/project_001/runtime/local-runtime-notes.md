...
- This run landed a stronger preferred main-world `executeJavaScript` bridge path in the shell, but Electron smoke now aborts in macOS AppKit before MyIDE emits its own main-process marker, so the new bridge could not be verified end-to-end here.

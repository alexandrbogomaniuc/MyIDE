...
- a confirmed reload-time hit for the current mirrored static override candidate

## Current local launch path
- `http://127.0.0.1:38901/runtime/project_001/launch`

## Current exact blocker
- The shell can now trace one grounded static runtime candidate back to a local mirror file path, but the runtime still does not confirm a reload-time hit for that mirrored candidate after override reload.

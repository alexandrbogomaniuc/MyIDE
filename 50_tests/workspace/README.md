...
- The create-object smoke test proves a new placeholder preset object can be created, aligned to the snap grid, reassigned to another editable layer, synced into replay-facing output, then duplicated and deleted cleanly before restore.

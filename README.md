...
## Current Phase
- Current milestone: PHASE 5Q live shell create -> layer reassignment -> save -> reload proof slice on top of the folder-based multi-project workspace.

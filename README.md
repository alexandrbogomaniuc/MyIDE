...
## Current Phase
- Current milestone: PHASE 5S live shell create -> align -> save -> reload proof slice on top of the folder-based multi-project workspace.

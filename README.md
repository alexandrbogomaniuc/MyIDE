...
## Current Phase
- Current milestone: PHASE 5O live shell create -> duplicate/delete -> save -> reload proof slice on top of the folder-based multi-project workspace.

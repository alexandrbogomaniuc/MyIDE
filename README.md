...
## Current Phase
- Current milestone: PHASE 5N live shell create -> drag -> save -> reload proof slice on top of the folder-based multi-project workspace.

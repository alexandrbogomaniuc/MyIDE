...
## Current Phase
- Current milestone: PHASE 5R live shell create -> resize -> save -> reload proof slice on top of the folder-based multi-project workspace.

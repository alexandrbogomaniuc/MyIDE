...
## Current Phase
- Current milestone: PHASE 5P live shell create -> reorder -> save -> reload proof slice on top of the folder-based multi-project workspace.

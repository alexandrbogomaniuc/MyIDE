...
- It now also emits `section-skin-material-plans/<family>--<section>.json` plus `section-skin-material-plan-profiles.json`, which show whether a reconstruction-ready section actually has the exact atlas page images locally or only related image candidates.
